...
void loop()
{
    ...
    while(colorRec){
        ...
        if(AIStarter_SmartBotGetColorSenor(COLORSENOR1,RCOLOR) - AIStarter_SmartBotGetColorSenor(COLORSENOR1,GCOLOR) > Threshold &&
           AIStarter_SmartBotGetColorSenor(COLORSENOR1,RCOLOR) - AIStarter_SmartBotGetColorSenor(COLORSENOR1,BCOLOR) > Threshold) {
            colorState = RED;
            Serial.println("ENTER RLINE");
        } else if(AIStarter_SmartBotGetColorSenor(COLORSENOR1,GCOLOR) - AIStarter_SmartBotGetColorSenor(COLORSENOR1,RCOLOR) > Threshold &&
           AIStarter_SmartBotGetColorSenor(COLORSENOR1,GCOLOR) - AIStarter_SmartBotGetColorSenor(COLORSENOR1,BCOLOR) > Threshold) {
            colorState = GREEN;
